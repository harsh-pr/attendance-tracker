...
export default function Auth() {
  ...
  async function handleGoogleSignIn() {
    ...
    try {
      ...
      // If user closed or dismissed popup without selecting an account,
      // silently bring them back to this page with clean state.
      if (
      ...
      if (err.code === "auth/popup-blocked") {
        friendlyMessage = "Google popup was blocked by your browser. Please allow popups for this site.";
    ...
    <div className="relative min-h-screen lg:h-screen lg:max-h-screen flex items-center justify-center px-4 py-4 sm:py-6 overflow-hidden bg-black text-white">
      ...
      <div className="absolute top-4 sm:top-6 right-4 sm:right-6 z-30">
        <motion.button
          whileTap={{ scale: 0.9 }}
          onClick={toggleTheme}
          className="flex relative w-12 h-6 rounded-full bg-zinc-200/90 dark:bg-zinc-800/90 transition-colors duration-200 cursor-pointer items-center p-0.5 border border-zinc-300/80 dark:border-zinc-700/80 shadow-sm backdrop-blur-md"
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        >
          <div className="bg-[#09090d] border border-zinc-800 shadow-[0_24px_60px_rgba(0,0,0,0.8)] rounded-3xl p-5 sm:p-6 space-y-4 transition-all duration-200 hover:border-zinc-700">
            ...
            >
              {loadingGoogle ? (
                <span className="w-4 h-4 border-2 border-zinc-400 border-t-blue-500 rounded-full animate-spin" />
              ) : (
